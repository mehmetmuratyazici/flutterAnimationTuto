                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                            width: MediaQuery.of(context).size.width * .05 + 30,
                            height:
                                MediaQuery.of(context).size.width * .05 + 30,
                            child: FloatingActionButton(
                        ...
                        child: SizedBox(
                          ...
                          child: Visibility(
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  if (cntNumberField.text != null &&
                                      cntNumberField.text.length > 0) {
                                    cntNumberField.text = cntNumberField.text
                                        .substring(
                                            0, cntNumberField.text.length - 1);
                                    if (cntNumberField.text == '') {
                                      setState(() {
                                        _visible = false;
                                      });
                                    }
